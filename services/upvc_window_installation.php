...
include('.././includes/header.php');
 ...
 ?>
        ...
        <div class="page-content">
            ...
            <!-- INNER PAGE BANNER -->
            <div class="wt-bnr-inr overlay-wraper bg-center" style="background-image:url(../img/Window%20Installation-banner.webp);" alt="aluminum" >
                                ...
                                <div class="section-content service-full-info">
                                    ...
                                    <div class="services-etc m-b30">
                                        <div class="wt-media m-b30">
                                            <img src="../img/upvc-Window installation-medium.webp" alt="aluminum"> 
                                        </div>                                        
                                        <div class="text-left">
                                        ...
                                        <div class="wt-info">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-lg-4 m-b30"><img src="../img/UPVC-window-1.webp" alt="upvc"></div>
                                                <div class="col-md-6 col-lg-4 m-b30"><img src="../img/UPVC-window-3.webp" alt="upvc"></div>
                                                <div class="col-md-6 col-lg-4 m-b30"><img src="../img/UPVC-window-4.webp" alt="upvc"></div>
                                              </div>                                            
                                    ...
                                    <div class="service-provide p-a30  site-bg-gray-light">
                                      <h4 class="wt-title m-b20">Why Choose Us as Your UPVC Windows Provider?</h4>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                <div class="wt-media">
                                                    <img src="../img/UPVC-window-2.webp" alt="upvc"> 
                                                </div>                                            
                                            </div>
