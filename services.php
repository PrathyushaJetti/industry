                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="service-icon-box-two">
                                    ...
                                    <div class="service-icon-box-title">
                                        <h4 class="wt-title"><a href="service-detail.html">Aluminum Work</a></h4>
                                    </div>
                                    ...
                                    <div class="service-icon-box-content">
                                        ...
                                        <a href="aluminum-profiles.html" class="site-button-link site-text-primary">Read More</a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="service-icon-box-two">
                                    ...
                                    <div class="service-icon-box-title">
                                        <h4 class="wt-title"><a href="service-detail.html">UPVC Work </a></h4>
                                    </div>
                                    
                                    <div class="service-icon-box-content">
                                        <p>You can dream, create, design, and build the most wonderful place in the world. But it requires people.</p>
                                        <a href="upvc-profiles.html" class="site-button-link site-text-primary">Read More</a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="service-icon-box-two">
                                    ...
                                    <div class="service-icon-box-title">
                                        <h4 class="wt-title"><a href="service-detail.html"> Glass Work </a></h4>
                                    </div>
                                    
                                    <div class="service-icon-box-content">
                                        <p>You can dream, create, design, and build the most wonderful place in the world. But it requires people.</p>
                                        <a href="glass-work.html" class="site-button-link site-text-primary">Read More</a>
                                    </div>
