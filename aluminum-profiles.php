...
<div class="page-content">
    ...
    <div class="section-full p-t120  p-b90" style="background-image:url(images/background/map-bg-dark2.png);">
        ...
        <div class="container">
            ...
            <div class="section-head center wt-small-separator-outer">
                ...
                <h2 class="wt-title">We Provide Best Aluminum Services</h2>
            </div>
            <!-- TITLE END-->
            <div class="s-section">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 m-b30">
                        <div class="service-icon-box-two">
                            ...
                            <div class="service-icon-box-title">
                                <h4 class="wt-title">
                                    <a href="<?= ROOT_PATH ?>/services/aluminum_window_installation.php"> Window
                                        Installation </a>
                                </h4>
                            </div>

                            <div class="service-icon-box-content">
                                <p>Aluminum windows offer durability, style, and low maintenance, making them ideal for
                                    modern spaces. Contact AS Enterprises for expert installation services.</p>
                                <a href="<?= ROOT_PATH ?>/services/aluminum_window_installation.php" class="site-button-link site-text-primary"> Read More</a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 m-b30">
                        <div class="service-icon-box-two">
                            ...
                            <div class="service-icon-box-title">
                                <h4 class="wt-title">
                                    <a href="<?= ROOT_PATH ?>/services/aluminum_partition_installation.php"> Partition
                                        Installation </a>
                                </h4>
                            </div>

                            <div class="service-icon-box-content">
                                <p>AS Enterprises provides durable, stylish aluminum profile doors with customizable
                                    designs, eco-friendly materials, and professional installation at competitive
                                    prices.</p>
                                <a href="<?= ROOT_PATH ?>/services/aluminum_partition_installation.php" class="site-button-link site-text-primary">
                                    Read More</a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 m-b30">
                        <div class="service-icon-box-two">
                            ...
                            <div class="service-icon-box-content">
                                <p>Aluminum doors are durable, stylish, low-maintenance, and energy-efficient, offering
                                    various designs at affordable prices, ideal for homes and offices.</p>
                                <a href="<?= ROOT_PATH ?>/services/aluminum_door_installation.php" class="site-button-link site-text-primary">
                                    Read More</a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 m-b30">
                        <div class="service-icon-box-two">
                            ...
                            <div class="service-icon-box-content">
                                <p>Aluminum glazing offers durable, stylish glass installations for homes or businesses,
                                    providing insulation, low maintenance, and a modern look for any space.</p>
                                <a href="<?= ROOT_PATH ?>/services/glazing_work.php" class="site-button-link site-text-primary">
                                    Read More</a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 m-b30">
                        <div class="service-icon-box-two">
                            ...
                            <div class="service-icon-box-title">
                                <h4 class="wt-title">
                                    <a href="<?= ROOT_PATH ?>/services/profile_door_installation.php" class="site-button-link site-text-primary"> Profile Door
                                        Installation </a>
                                </h4>
                            </div>

                            <div class="service-icon-box-content">
                                <p>Aluminum partitions are a modern, durable solution to divide spaces affordably,
                                    offering privacy and style for offices, homes, and commercial areas.</p>
                                <a href="<?= ROOT_PATH ?>/services/profile_door_installation.php" class="site-button-link site-text-primary">
                                    Read More</a>
                            </div>
    ...
    <div class="section-full  p-t120 p-b90 testimonial-2-outer site-bg-gray">
        ...
        <div class="container">
            ...
            <!-- TITLE END-->
            <div class="section-content">
                <div class="testimonial-2-content owl-carousel m-b30">
                    <!--block 1-->
                    <div class="item">
                        ...
                        <div class="testimonial-2">
                            <div class="testimonial-content">
                                <div class="testimonial-detail clearfix">
                                    ...
                                    <div class="testimonial-info">
                                        <span class="testimonial-name">David Lee</span>
