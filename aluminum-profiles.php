                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="service-icon-box-two">
                                    ...
                                    <div class="service-icon-box-title">
                                        <h4 class="wt-title"><a href="service-detail.html">Partition Installation </a></h4>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="service-icon-box-two">
                                    ...
                                    <div class="service-icon-box-title">
                                        <h4 class="wt-title"><a href="service-detail.html"> Door Installation </a></h4>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="service-icon-box-two">
                                    ...
                                    <div class="service-icon-box-title">
                                        <h4 class="wt-title"><a href="service-detail.html"> Glazing Work </a></h4>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30">
                                <div class="service-icon-box-two">
                                    ...
                                    <div class="service-icon-box-title">
                                        <h4 class="wt-title"><a href="service-detail.html">Profile Door Installation </a></h4>
                                    </div>
